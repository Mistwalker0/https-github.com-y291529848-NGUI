...
{
    public static void DoDelegate(UnityAction fun)
    {
        if (fun != null)
            fun();
    }

    public static void DoDelegate(UnityAction<object> fun,object data)
    {
        if (fun != null)
            fun(data);
    }
    ...
    internal static int IntParse(char[] v)
    {
    ...
    public static float GetGroundHeightAt(Vector3 target)
    {
        ...
        Ray r = new Ray
        {
            origin = new Vector3(target.x, 50, target.z),
    ...
    static string[] IntStrings = new string[]
   {
    ...
    public static Camera GetGUIUICamera()
    {
        return GameObject.Find("UIRoot/Camera").GetComponent<Camera>();
    }

    public static UICamera GetUICamera()
    {
        return GameObject.Find("UIRoot/Camera").GetComponent<UICamera>();
    }
    ...
    public static void GetSKillTypeRes(UISprite sprite, int type)
    {
        switch (type)
        {
            case 1:
                sprite.spriteName = "card_gongji";
                break;
            case 2:
                sprite.spriteName = "card_hujia";
                break;
            case 3:
                sprite.spriteName = "card_zhiliao";
                break;
            case 4:
                sprite.spriteName = "card_zengyi";
                break;
            case 5:
                sprite.spriteName = "card_jianyi";
                break;
            case 6:
                sprite.spriteName = "card_texiao";
                break;
        }
    }
    /// <summary>
    ...
    {
        T obj = default(T);
        obj = trans.Find(name).GetComponent<T>();
        return obj;
    }
