...
public class UICenterOnChild : MonoBehaviour
{
    ...
    public delegate void OnCenterGameObject(UIGridItem go);
    public OnCenterGameObject onCenterGameObject;
    ...
    void CenterOn(Transform target, Vector3 panelCenter)
    {
        if (target != null && mScrollView != null && mScrollView.panel != null)
        {
            ...
            if (onCenterGameObject != null)
                onCenterGameObject(target.GetComponent<UIGridItem>());
